package com.mx.contratos.application.configuration;
...
public class LoggingAspect {
	...
	private static final String BANK_AGGREGATION_CLASSNAME = "BankAggregation";
	 ...
	 */
	@Pointcut("within(com.mx.contratos.domain.use_case..*) "
		+ " || within(com.mx.contratos.application.controller..*)")
