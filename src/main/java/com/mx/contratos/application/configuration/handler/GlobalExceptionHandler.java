package com.mx.contratos.application.configuration.handler;

import com.mx.contratos.application.configuration.handler.response.ResponseError;
import  com.mx.contratos.application.configuration.handler.response.Error;
import com.mx.contratos.domain.exception.BadRequestException;
import com.mx.contratos.domain.exception.ItemNotFoundException;
